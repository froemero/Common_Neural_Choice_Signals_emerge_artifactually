...
load(strcat('~/Dropbox (Brown)/CLPS-ShenhavLab/EEG_Studies/Experiments/BASS_EEG/Data/export/chanlocs.mat'))
...
nameFolds= { 'PCAppraisal_PCChoiceDifficulty'};%,'HLMLiking_Anxiety_Confidence', 'MMMLiking_Anxiety_Confidence','VD_OV',, 'PCA_PCValuation_PCChoiceDifficulty', 'PCA_PCValuation_PCChoice', 'PCA_PCValuation_PCChoiceDiff','PCA_PCValuation_PCChoiceDiff_PCChoiceCert'
