...
function fitModel(events,eeg;epoched=false)
 ...
 m  = Unfold.fit(UnfoldModel,
	Dict(
		"Stimulus"=>(stimForm,firbasis((-0.3,1.5),sfreq,"Stimulus")),
		"Response"=>(respForm,firbasis((-1.5,1),sfreq,"Response"))
...
git-tree-sha1 = "50f50a9dd7e9c42e75a77ace891e7813c04896c6"
