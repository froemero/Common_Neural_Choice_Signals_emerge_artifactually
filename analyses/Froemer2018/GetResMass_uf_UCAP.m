...
if isMain
delete(strcat(PATH, 'Writing/', 'MASSRESULTS_UF_no_dc'))
diary(strcat(PATH, 'Writing/', 'MASSRESULTS_UF_no_dc'))
...
for nmodels = 1: length(nameFolds)
    ...
    for currthresh = 1: length(threshVals)
        ...
        colcount=0;
        load(strcat(PATH, 'Second_level/Export/',nameFolds{nmodels}, '_',threshVals{currthresh},'/ROI_data_no_dc.mat'))
        % get fieldnames
