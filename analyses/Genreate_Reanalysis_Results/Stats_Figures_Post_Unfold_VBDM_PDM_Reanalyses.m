...
Pisauro = readtable(sprintf('%sPisauro/post_unfold/allEffects_channelCluster 2', basepath));
...
export_fig(sprintf('%sPisauro_Reanalysis', figpath),'-pdf','-painters');
...
set(gca,'TickDir','out', 'Box', 'off')
set(gcf,'position',figsize)
export_fig(sprintf('%sPisauro_Reanalysis_slocked', figpath),'-pdf','-painters');
...
set(gca,'TickDir','out', 'Box', 'off')
set(gcf,'position',figsize)
export_fig(sprintf('%sUCAP_Reanalysis', figpath),'-pdf','-painters');
...
set(gca,'TickDir','out', 'Box', 'off')
set(gcf,'position',figsize)
export_fig(sprintf('%sUCAP_Reanalysis_slocked', figpath),'-pdf','-painters');



%% Same for Steinemann
Steinemann = readtable(sprintf('%sSteinemann_2018/preprocessing_for_Unfold/post_unfold/steinemann/2023_romy_steinemann_filtered_-Pz', basepath));
...
set(gca,'TickDir','out', 'Box', 'off')
set(gcf,'position',figsize)
export_fig(sprintf('%sSteinemann_Reanalysis', figpath),'-pdf','-painters');
...
set(gca,'TickDir','out', 'Box', 'off')
set(gcf,'position',figsize)
export_fig(sprintf('%sSteinemann_Reanalysis_slocked', figpath),'-pdf','-painters');


%% Same for Boldt
Boldt = readtable(sprintf('%sBoldt_et_al_2019/prep_Boldt_unfold/post_unfold/boldt/2023_romy_boldt_-PZ', basepath));
...
set(gca,'TickDir','out', 'Box', 'off')
set(gcf,'position',figsize)
export_fig(sprintf('%sBoldt_Reanalysis', figpath),'-pdf','-painters');
...
set(gca,'TickDir','out', 'Box', 'off')
set(gcf,'position',figsize)
export_fig(sprintf('%sBoldt_Reanalysis_slocked', figpath),'-pdf','-painters');
