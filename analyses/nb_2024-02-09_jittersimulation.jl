...
# ╔═╡ d27d6472-c71c-11ee-0672-e9425e03744f
begin
	using UnfoldSim
	using UnfoldMakie
	using CairoMakie
...
# ╔═╡ 9e682da0-3cce-4800-909e-cf73be44709d
md"""
|||
|---|---
|Jitter width| $(@bind jitter PlutoUI.Slider(0:0.001:0.2,default=0.05,show_value=true))sec|
|Offset (stim duration) | $(@bind offset PlutoUI.Slider(0.01:0.01:1,default=0.4,show_value=true))sec
|(pink)-noise | $(@bind noiselevel PlutoUI.Slider(0:1:10,default=0,show_value=true))
"""

# ╔═╡ 422183d9-e438-438d-9ecb-1c73712f630b
sfreq = 100

# ╔═╡ 5bc9f446-c5a8-4a28-9d4d-e681d1ab115a
design =
    SingleSubjectDesign(;
        conditions = Dict(
            :condition => ["car", "face"],
...
# ╔═╡ 94ba0b55-fcf5-4766-b47a-09ca0a373c76
begin
...
# ╔═╡ 3fd6fb43-b2dd-401e-858d-8e5d625a8a73
data, evts = simulate(
...
# ╔═╡ 02affc1a-f9f2-4fb8-b277-b4d0910b9cf9
let 
	f = Figure()
...
# ╔═╡ 6aa4751f-6905-4bdd-ad67-f1c180bb5218
c = coeftable(m);

# ╔═╡ f422ae74-e8d0-4858-ba73-7caa39854cec
let
	f = Figure()
	plot_erp!(f[1,1],c)
...
# ╔═╡ e2427063-c271-4a98-8a55-fda9fd2e94e9


# ╔═╡ f81013ee-fc2f-4a41-8e8a-ae28fa8c58f0
...
manifest_format = "2.0"
project_hash = "202451c67fb7864ff252d8711ebaf36f73d7d9d9"
...
git-tree-sha1 = "672ca3b661bc265eaa4e8ad0d644c3f88bd6d18a"
...
[[deps.TopoPlots]]
deps = ["CloughTocher2DInterpolation", "Delaunator", "Dierckx", "GeometryBasics", "InteractiveUtils", "LinearAlgebra", "Makie", "Parameters", "PrecompileTools", "ScatteredInterpolation", "Statistics"]
git-tree-sha1 = "1beec0b4a5a4c4c072b1f2b871e49e45d09cdfb4"
...
git-tree-sha1 = "2ec7b5240ef7361724ea85955c1571333e9e2f50"
...
[[deps.UnfoldMakie]]
deps = ["AlgebraOfGraphics", "CategoricalArrays", "ColorSchemes", "ColorTypes", "Colors", "CoordinateTransformations", "DataFrames", "DataStructures", "DocStringExtensions", "GeometryBasics", "GridLayoutBase", "ImageFiltering", "Interpolations", "LinearAlgebra", "Makie", "SparseArrays", "StaticArrays", "Statistics", "TopoPlots", "Unfold"]
git-tree-sha1 = "f121d87daa18b00be7f47415f900422e50607a09"
...
git-tree-sha1 = "45ace6d78a8cab1e23e846fe84d45b659f034118"
