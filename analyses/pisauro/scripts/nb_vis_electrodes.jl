...
# ╔═╡ 8e0fabd6-bf77-11ed-2d89-4d99b8fd3749
begin
	using CairoMakie
	using CSV
	using DataFrames
...
# ╔═╡ 4fa05601-9902-4318-802f-79a7c6e7c094
using PyMNE

# ╔═╡ 4eba397e-b920-47cd-af12-11a690001819
using CoordinateTransformations

# ╔═╡ 9149dd18-ccfc-48c7-8e08-930e580a80d9
dig = PyMNE.channels.read_custom_montage("../data/efMRIcap64.elp")

# ╔═╡ fdc74ea6-e2be-4bfe-b56d-46b402db3cd3
dig.plot()

# ╔═╡ 7bf3e324-4c0d-40ea-9577-4e6bf613e551
[findfirst(pyconvert.(String,dig.ch_names) .== k) for k in ["CPz","Pz","CP2","P2","CP4","P4","PO1","PO2","P1"]]

# ╔═╡ e5cafa2e-3db2-40ec-96f8-532303f93a06
findfirst(pyconvert.(String,dig.ch_names) .== "Fp1")

# ╔═╡ 1bab7f41-d4aa-402a-9bde-34d628f40517
lay = CSV.read("../data/efMRIcap64.elp",DataFrame,header=0)

# ╔═╡ 851c3208-0ea0-4fb1-9693-91d2a8b58539
begin

text(lay.Column2,lay.Column3,text=lay.Column1)
end

# ╔═╡ 22f37280-7b63-4218-ac6d-db6ab9f59da2
begin
pos_cart = collect(hcat(CartesianFromPolar().(Polar.(lay.Column2,lay.Column3./(2*π)))...))
text(pos_cart[1,:],pos_cart[2,:],text=lay.Column1)
end

# ╔═╡ 9f862fff-2bfb-409b-8040-c199e66ad8e5
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "ef036a528737560c8ffeeb8b864c0fe224a2fa7b"
